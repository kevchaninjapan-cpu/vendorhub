  ...
  return (
    <Card className="w-full max-w-lg animate-vh-slide-in">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-3 rounded-xl bg-surface-2/50 px-3 py-2.5">
          <div>
        ...
        {comparables && comparables.count > 0 && (
          <div className="grid grid-cols-4 gap-3 rounded-xl bg-surface-2/50 px-3 py-2.5">
            <div>
              <p className="text-[10px] text-muted uppercase tracking-wider">Comps</p>
              <p className="text-xs font-semibold text-foreground">{comparables.count}</p>
            </div>
            <div>
